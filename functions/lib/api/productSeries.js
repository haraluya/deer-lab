...
exports.createProductSeries = (0, https_1.onCall)((0, apiWrapper_1.apiWrapper)({
    requireAuth: true,
    handler: async (request) => {
        ...
        try {
            ...
            errorHandler_1.ErrorHandler.handle(error, `建立產品系列 ${name}`, contextAuth === null || contextAuth === void 0 ? void 0 : contextAuth.uid);
        }
    }
}));
exports.updateProductSeries = (0, https_1.onCall)((0, apiWrapper_1.apiWrapper)({
    requireAuth: true,
    handler: async (request) => {
        const { data, auth: contextAuth } = request;
        // await ensureIsAdmin(contextAuth?.uid);
        ...
        try {
            ...
            if (oldProductType !== productType) {
                ...
                if (!productsQuery.empty) {
                    ...
                    firebase_functions_1.logger.info(`已更新 ${updatedProductsCount} 個產品的產品代號`);
                }
            }
            ...
            errorHandler_1.ErrorHandler.handle(error, `更新產品系列 ${seriesId}`, contextAuth === null || contextAuth === void 0 ? void 0 : contextAuth.uid);
        }
    }
}));
exports.deleteProductSeries = (0, https_1.onCall)((0, apiWrapper_1.apiWrapper)({
    requireAuth: true,
    handler: async (request) => {
        var _a;
        const { data, auth: contextAuth } = request;
        ...
        try {
            ...
            const seriesName = seriesDoc.exists ? (_a = seriesDoc.data()) === null || _a === void 0 ? void 0 : _a.name : seriesId;
            ...
            errorHandler_1.ErrorHandler.handle(error, `刪除產品系列 ${seriesId}`, contextAuth === null || contextAuth === void 0 ? void 0 : contextAuth.uid);
        }
    }
}));
