...
#### 📋 備份檔案清理清單
- [ ] `src/app/dashboard/materials/MaterialDialog-backup.tsx`
- [ ] `src/app/dashboard/products/page-backup.tsx`  
- [ ] `src/app/dashboard/suppliers/page-backup.tsx`
- [ ] `src/app/dashboard/fragrances/page-backup.tsx`
...
#### 1. 時間記錄頁面
- [ ] **檔案**: `src/app/dashboard/time-records/page.tsx`
- [ ] **目標**: 將 `httpsCallable` 改為 `useApiClient`
- [ ] **重點**: 保留原有的分頁、篩選、統計功能
...
#### 2. 人員權限管理頁面  
- [ ] **檔案**: `src/app/dashboard/personnel/permissions/page.tsx`
- [ ] **目標**: 遷移至 `useApiClient`
- [ ] **重點**: 保留權限管理的所有功能
...
#### 3. 採購訂單詳情頁面
- [ ] **檔案**: `src/app/dashboard/purchase-orders/[id]/page.tsx`
- [ ] **目標**: 統一API調用方式
- [ ] **重點**: 保留詳細頁面的所有功能
...
#### 4. 產品系列管理頁面
- [ ] **檔案**: `src/app/dashboard/product-series/page.tsx`  
- [ ] **目標**: 整合 `StandardDataListPage` + `useApiClient`
- [ ] **重點**: 這是統一架構的最佳實踐案例
...
#### 5. 生產計算器頁面
- [ ] **檔案**: `src/app/dashboard/production-calculator/page.tsx`
- [ ] **目標**: 遷移API調用但保留計算邏輯
- [ ] **重點**: 特殊計算功能需要特別測試
...
#### 6. 角色建立對話框
- [ ] **檔案**: `src/components/RoleCreateDialog.tsx`
- [ ] **目標**: 使用 `StandardFormDialog` + `useApiClient`
- [ ] **重點**: 統一對話框的標準實現

#### 7. 角色編輯對話框
- [ ] **檔案**: `src/components/RoleEditDialog.tsx`
- [ ] **目標**: 使用 `StandardFormDialog` + `useApiClient`
- [ ] **重點**: 與建立對話框保持一致性

#### 8. 用戶角色分配對話框
- [ ] **檔案**: `src/components/UserRoleAssignDialog.tsx`
- [ ] **目標**: 使用 `StandardFormDialog` + `dataLoaderConfig`
- [ ] **重點**: 智能載入使用者和角色資料

#### 9. 產品系列對話框
- [ ] **檔案**: `src/app/dashboard/product-series/SeriesDialog.tsx`
- [ ] **目標**: 使用 `StandardFormDialog` + `dataLoaderConfig`
- [ ] **重點**: 配合產品系列頁面的統一架構

#### 10. 供應商對話框
- [ ] **檔案**: `src/app/dashboard/suppliers/SupplierDialog.tsx`
- [ ] **目標**: 使用 `StandardFormDialog` + `dataLoaderConfig`
- [ ] **重點**: 供應商資料的統一處理
