...
import { 
  ...
  PackageSearch, UserCheck, Zap, Eye, Droplets
} from "lucide-react";
  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        {canShowCard('/dashboard/personnel') && (
          <Card 
        ...
        {canShowCard('/dashboard/cost-management') && (
          <Card 
        ...
        {/* 工時管理卡片 - 所有人都能查看自己的工時 */}
        <Card 
          className="bg-gradient-to-br from-indigo-50 to-blue-50 border-indigo-200 hover:shadow-lg transition-all duration-200 cursor-pointer hover:scale-105"
          onClick={() => handleCardClick('/dashboard/time-records')}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-indigo-700">我的工時</CardTitle>
      ...
      <Card className="bg-gradient-to-r from-background to-muted/50 border-border">
        ...
        <CardContent>
          <p className="text-muted-foreground mb-4">
            點擊上方卡片可快速訪問對應的管理功能。根據您的角色權限，系統會展示您可以訪問的功能模組。
          </p>
