...
export function SupplierDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[95vh] overflow-hidden bg-gradient-to-br from-white via-slate-50/30 to-blue-50/20 border-0 shadow-2xl backdrop-blur-sm" aria-describedby="supplier-dialog-description">
